package com.abrarshakhi.envelope.ui.onboarding
...
import com.abrarshakhi.envelope.navigation.AdminSetup
import com.abrarshakhi.envelope.navigation.AppRoute
import com.abrarshakhi.envelope.navigation.ContactsSetup
import com.abrarshakhi.envelope.navigation.PermissionsSetup
import com.abrarshakhi.envelope.navigation.SelfDestructSetup
import com.abrarshakhi.envelope.navigation.UnlockPasswordSetup
...
fun LoginScreen(
    ...
    FlowScreen(
        title = "Sign in",
        body = "Sign-in fields will live here. Continuing moves to first-time setup.",
...
@Composable
fun DashboardScreen(onBack: () -> Unit, modifier: Modifier = Modifier) {
    FlowScreen(
        title = "Aegis SOS dashboard",
        body = "Readiness overview, emergency status, and quick actions will live here.",
